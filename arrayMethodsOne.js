...
// CODE HERE
const myStrongest = monstersInYourPocket.filter((monsterObj) => {
  if(monsterObj.CP > 200) {
    return monsterObj.CP
  }
})
...
// CODE HERE
// with Arrow Function
orders.forEach((taxNum, i) => console.log(taxNum.price * (1 + taxNum.tax)))

console.log('----------------')

// without Arrow Function
orders.forEach(function(taxNum, i){
  console.log(taxNum.price * (1 + taxNum.tax))
})

console.log('----------------')

// without .forEach
// function addTax(taxNum, orders) {
//   for(let i = 0; i < orders.keys(obj).length; i++) {
//     taxNum.price = taxNum.price * (1 + taxNum.tax)
//   }
//   return taxNum.price
// }

// console.log(addTax(orders))
...
// purchases.forEach((bobsTotal, i) => {
//   if(bobsTotal.owner === 'Bob'){
//     bobsTotal.price += bobsTotal.price
//   }
...
purchases.forEach(function(bobsTotal, i) {
  if(bobsTotal.owner === 'Bob') {
    let total = total += bobsTotal.price
  }
  console.log(total)
